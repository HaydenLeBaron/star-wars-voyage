...
Gear	(Restricted)	Price	Rare.	Features
...
Cortex Bomb	(Restricted)	1200	6	Detonates in response to code-word/signal
Cyber Disguise	(Restricted)	18000	8	Indistinguishable talent ranks & counts as disguise kit
...
Cybernetic Cavity	(Restricted)	775	3	Hidden Storage talent rank, and can hide item within body
...
Digital Lockpick	(Restricted)	2750	5	Bypass Security talent rank
Escape Circuit	(Restricted)	1000	6	Allows droid to escape restraining bolt easily
...
Lockbreaker Hand	(Restricted)	2200	6	Bypass Security talent rank & assists in getting through locks
Multi-Tool Hand		650	4	Counts as a Tool Kit
Networked Slicing Uplink	(Restricted)	1250	7	For droids, counts as Slicer Gear & harder to identify
...
Neuromachine Interface	(Restricted)	3500	6	Can use Coordination instead of a Piloting skill to pilot
...
Retinal Implant	(Restricted)	1250	6	Can change retina to fool retinal scanners
